...
class FKMNLConstants:
        ...
        self._all_constants = pd.DataFrame(
            {
                "Steel": {
                    ...
                    # values for P_RAJ
                    "d_RAJ":
                    # table 2.33 (2.41) Note, this is -0.56 in the FKM nonlinear document, however due to an error by the authors, the value was corrected later (e-mail of Moritz Hupka 15.09.22 10:27)
                    -0.63,
                    "f_25percent_material_woehler_FKM_nonlinear_RAJ":
                    # This value is listed as 0.39, table 2.33 in FKM nonlinear 2019, and as 0.35 in table 35 in report "Rauheit und Randschicht 2022".
                    0.39,
                    "f_25percent_material_woehler_FKM_roughness_RAJ": 0.25,  # table 35 in report "Rauheit und Randschicht 2022"
                    "a_PZ_RAJ":
                    # Note, this is 1.173 in the FKM nonlinear document, however due to an error by the authors, the value was corrected later (e-mail of Moritz Hupka 15.09.22 10:27)
                    10,
                    "b_PZ_RAJ":
                    # Note, this is 1 in the FKM nonlinear document, however due to an error by the authors, the value was corrected later (e-mail of Moritz Hupka 15.09.22 10:27)
                    0.826,
                    "a_PD_RAJ": 3.33e-5,
                    "b_PD_RAJ": 1.55,
                },
    ...
    def for_material_group(self, assessment_parameters):
        ...
        resulting_constants["f_25percent_material_woehler_RAM"] = resulting_constants[
            "f_25percent_material_woehler_FKM_nonlinear_RAM"
        ]
        resulting_constants["f_25percent_material_woehler_RAJ"] = resulting_constants[
            "f_25percent_material_woehler_FKM_nonlinear_RAJ"
        ]
